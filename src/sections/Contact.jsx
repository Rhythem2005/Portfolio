    ...
    try {
      await emailjs.send(
        ...
        "template_zj0etlm",   
        {
          ...
          to_name: "Rhythem Sabharwal",
          to_email: "rhythemsabharwal@gmail.com", 
    ...
    <section className="relative flex items-center c-space section-spacing">
      ...
      <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden w-full">
        ...
        <motion.div
          ...
          className="flex-[0.75] max-w-md p-8 mx-auto xl:mx-0 border border-white/10 rounded-2xl bg-primary"
        >
          <div className="flex flex-col items-start w-full gap-5 mb-10">
            <h2 className="text-heading">Let's Talk</h2>
            <p className="font-normal text-neutral-400">
              Available for jobs, internships, collaborations, or enlightening discussions—
              basically anything that involves building, improving, or occasionally 
              pretending to know what we’re doing. If you have a project, I’m probably 
              the person you’re reluctantly glad to have on board.
            </p>
          </div>
